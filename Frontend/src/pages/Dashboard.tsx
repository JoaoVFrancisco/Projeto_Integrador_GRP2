...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, marginBottom: 20, color: '#ea580c', textAlign: 'center' },
...
const ProductionReport = ({ data, inventoryData, stats }: any) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <Text style={styles.title}>ArcelorMittal Production Report</Text>
      ...
      <Text style={styles.footer}>
        Generated by ArcelorMittal Production Management System
      </Text>
    </Page>
  </Document>
);
...
// Calculate initial operational efficiency
